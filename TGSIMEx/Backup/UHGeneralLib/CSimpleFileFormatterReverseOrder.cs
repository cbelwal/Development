...
{
    public class CSimpleFileFormatterReverseOrder: IFileFormatter
    {
        private string _message;

        public string Description
        {
            get { return "Comma Separated Format (CSV) File, in RM Reverse Priority Order (Task N has highest priority)"; }
        }
